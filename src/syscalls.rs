...
pub(crate) unsafe fn io_uring_enter(ring_fd: &OwnedFd, submit: u32, min_complete: u32, flags: IoUringEnterFlags, sigset: *mut sigset_t, sz: u32) -> NumberOfIOsSuccessfullyConsumed {
    syscall(__NR_io_uring_enter as c_long, ring_fd.as_raw_fd(), submit, min_complete, flags.bits(), sigset, sz)
}
